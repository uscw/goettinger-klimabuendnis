...
function fnShowQuestionNumber(questionNumber)
{
	...
	questionNumber++;
        if ( arQuestionsOptFullPro[questionNumber] != "" ) {
        	$("#votingFullPro").html(arQuestionsOptFullPro[questionNumber])
        } else {
        ...
        if ( arQuestionsOptContra[questionNumber] != "" ) {
        	$("#votingContra").html(arQuestionsOptContra[questionNumber])
        } else {
        	$("#votingContra").html(TEXT_VOTING_CONTRA)
        }
        if ( arQuestionsOptFullContra[questionNumber] != "" ) {
        	$("#votingFullContra").html(arQuestionsOptFullContra[questionNumber])
        } else {
        	$("#votingFullContra").html(TEXT_VOTING_FULLCONTRA)
        }

	$("#votingFullPro").unbind("click");
	$("#votingPro").unbind("click");
	$("#votingNeutral").unbind("click");
	$("#votingContra").unbind("click");
	$("#votingFullContra").unbind("click");
	...
	if (questionNumber < arQuestionsLong.length) 
	{
	   ...
	   $("#votingFullPro").click(function () {
		arPersonalPositions[questionNumber] = 2;
	   ...
	   $("#votingFullContra").click(function () { 
	   	arPersonalPositions[questionNumber] = -2;
	   	fnShowQuestionNumber(questionNumber);
	   });
