...
class publisher():
    ...
    def prepare_article_post(self,file):
        ...
        if len(imgs) == 0:
            img_file = "out.jpg"
            img_dir = "/tmp/"
            self.BG = socialmedia_text2img.bg_canvas(500,500)
