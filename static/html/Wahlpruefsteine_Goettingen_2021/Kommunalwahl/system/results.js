...
//	for (i = 0; i <= arQuestionsShort.length-1; i++)
	for (i = 0; i <= intQuestions-1; i++)
	{
		...
		var counterFullContra = 0;
		var counterContra = 0;
		var counterNeutral = 0;
		var counterPro = 0;
		var counterFullPro = 0;
		var counterSkip = 0;
...
//	for (i = 0; i <= arQuestionsShort.length-1; i++)
	for (i = 0; i <= intQuestions-1; i++)
	{
		// immer sechs Werte im Array pro Frage

		var percentFullContra = fnPercentage(arMowpersonalSumFullContra[i],maxValues);
		...
		var percentFulPro = fnPercentage(arMowpersonalSumFullPro[i],maxValues);
		...
		content += "<tr>";
			content += "<td>";
				content += arMowpersonalFullSumContra[i]+"/"+maxValues+" [-] ";
			content += "</td>";
			content += "<td>";
				// content += "<img src='img/contra_px.png' height='12' width="+(percentFullContra * faktor)+" border='1' title="+arMowpersonalFullSumContra[i]+"/"+maxValues+"> ";
				
				content += "<div class='progress'>"
				content += "	<div class='progress-bar bg-danger' role='progressbar' style='width:"+percentFullContra+"%'>"+percentFullContra+"% </div> "
				content += "</div>"	
		...
		content += "<tr>";
			content += "<td>";
				content += arMowpersonalSumFullPro[i]+"/"+maxValues+" [+]";
			content += "</td>";
			content += "<td>";
				// content += "<img src='img/pro_px.png' height='12' width="+(percentFullPro * faktor)+" border='1' title="+arMowpersonalSumFullPro[i]+"/"+maxValues+"> ";

				content += "<div class='progress'>"
				content += "	<div class='progress-bar bg-success' role='progressbar' style='width:"+percentFullPro+"%'>"+percentFullPro+"% </div> "
				content += "</div>"	
